module MariaDB_Connector_ODBC_jll
...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import MariaDB_Connector_ODBC_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("1124d457-72a3-5205-9757-36a127c7d0f8"))
platforms = [Pkg.Artifacts.unpack_platform(e, "MariaDB_Connector_ODBC", artifacts_toml) for e in artifacts["MariaDB_Connector_ODBC"]]
...
if best_platform === nothing
    @debug("Unable to load MariaDB_Connector_ODBC; unsupported platform $(triplet(platform_key_abi()))")
else
